...
export const fridgeAlerts: FridgeAlert[] = [
  ...
  },
  {
    ...
    lastUpdate: new Date(),
    alertHistory: [
      { id: "ah1", type: "warning", temp: -17.5, timestamp: new Date(), acknowledged: false },
    ],
  },
  {
    id: "f3",
    ...
    lastUpdate: new Date(),
    alertHistory: [
      { id: "ah2", type: "critical", temp: 6.8, timestamp: new Date(), acknowledged: false },
      { id: "ah3", type: "warning", temp: 5.5, timestamp: new Date(Date.now() - 3600000), acknowledged: true },
    ],
  },
  {
    id: "f4",
...
// DONNÉES MISES À JOUR AVEC TES LIENS FIREBASE
export const usefulSites: UsefulSite[] = [
  {
    id: "s1",
    name: "CAF",
    description: "Les caisses d'allocations familiales gèrent les allocations familiales.",
    url: "https://www.caf.fr",
    category: "aides",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6745.JPG?alt=media&token=pulse-pilotage"
  },
  {
    id: "s2",
    name: "WIZBII",
    description: "WIZBII améliore votre pouvoir d'achat et facilite l'obtention de vos aides.",
    url: "https://www.wizbii.com",
    category: "aides",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6746.PNG?alt=media&token=pulse-pilotage"
  },
  {
    id: "s3",
    name: "PouvoirPlus",
    ...
    category: "avantages",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6446.PNG?alt=media&token=pulse-pilotage",
  },
  {
    id: "s4",
    name: "Combo",
    ...
    category: "planning",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6448%202.PNG?alt=media&token=pulse-pilotage",
  },
  {
    id: "s5",
    name: "Alan",
    ...
    category: "sante",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6751%202.PNG?alt=media&token=pulse-pilotage",
  },
  {
    id: "s6",
    name: "Ameli",
    ...
    category: "sante",
    icon:"https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6757.PNG?alt=media&token=pulse-pilotage",
  },
  {
    id: "s7",
    name: "Impots.gouv.fr",
    description: "Portail officiel de l'administration fiscale.",
    url: "https://www.impots.gouv.fr",
    category: "impots",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6753.PNG?alt=media&token=pulse-pilotage"
  },
  {
    id: "s8",
    name: "Service-Public.fr",
    description: "Le site officiel de l'administration française.",
    url: "https://www.service-public.fr",
    category: "aides",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6747.jpg?alt=media&token=pulse-pilotage"
  },
  {
    id: "s9",
    name: "Action Logement",
    description: "Aides au logement pour les salariés.",
    url: "https://www.actionlogement.fr",
    category: "logement",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6755.PNG?alt=media&token=pulse-pilotage"
  },
  {
    id: "s10",
    name: "France Travail (Pôle Emploi)",
    description: "Services pour les demandeurs d'emploi.",
    url: "https://www.francetravail.fr",
    category: "emploi",
    icon: "https://firebasestorage.googleapis.com/v0/b/objectif-restaurant.firebasestorage.app/o/app-icons%2FIMG_6756.PNG?alt=media&token=pulse-pilotage"
  },
]
