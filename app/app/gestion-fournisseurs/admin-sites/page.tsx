    ...
    return (
      <div className="min-h-screen bg-background pb-24">
        ...
        <main className="px-4 py-6 max-w-lg mx-auto space-y-6">
          <Link href="/gestion-fournisseurs" className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
            <ArrowLeft className="w-4 h-4" />
            <span className="text-sm">Retour</span>
          </Link>
          <div className="pulse-card p-5 border-destructive/30 bg-destructive/5">
            <p className="font-semibold">Accès restreint</p>
            <p className="text-sm text-muted-foreground mt-1">Cette page est réservée à l'administration.</p>
          </div>
        </main>
        <BottomNav />
      </div>
