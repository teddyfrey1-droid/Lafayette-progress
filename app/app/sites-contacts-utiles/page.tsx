...
function SitesContactsContent() {
  ...
  const isAdmin = me.isManagerOrAdmin
  ...
  const openSiteDialog = (site?: UsefulSite) => {
    if (site) {
      ...
      setImagePreview(site.icon || null)
    } else {
      setEditingSite(null)
      setSiteForm({ name: "", description: "", url: "", category: categories[0]?.id || "", icon: "" })
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setSiteForm({ ...siteForm, icon: base64String })
  ...
  return (
    <>
      ...
      {/* Site Dialog - Updated to use file upload instead of URL */}
        ...
        <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              {imagePreview ? (
                <div className="relative w-full h-32 rounded-xl border border-border overflow-hidden bg-muted">
                  <img
