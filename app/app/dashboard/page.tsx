...
// Note : on a retiré 'currentUser' de cet import car on utilise le hook maintenant
...
// Import du hook pour l'utilisateur connecté
...
export default function Dashboard() {
  ...
  // Sécurisation : on vérifie que 'user' et 'displayName' existent avant d'afficher
